...
//use \By\Otc\Http\Controllers\Api\V1 as API1;
use Illuminate\Contracts\Routing\Registrar as RouteContract;

Route::any('/develop',  HomeController::class.'@index');
...
Route::group(['prefix' => 'v1','middleware' => 'cors'], function (RouteContract $api) {
   ...
   $api->get('/test', "Api\V1\BootstrappersController@show");
...
//
//    //
//    $api->get('/cms/notice', API3\TestController::class.'@index');
//
//
//
//    /*
